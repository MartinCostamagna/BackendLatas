...
lista = ['APA', 'Americano', 'Americano sin Alcohol' 'Bitt', 'Cero Alcohol', 'Chenin Dulce', 'Chenin Torrontes', 'Cigarrillos', 'Demi-Sec', 'Energizante', 'Energizante Sin Azucar', 'Espumante', 'Fernet', 'Gaseosa', 'Gaseosa Ligth', 'Gaseosa Sin Azucar', 'Gin Tonic', 'Golden Ale', 'Golden Lager', 'Grape Lager', 'Hard Seltzer', 'Honigbier', 'IPA', 'IPA Roja', 'IPA de Cacao', 'Jugo',
